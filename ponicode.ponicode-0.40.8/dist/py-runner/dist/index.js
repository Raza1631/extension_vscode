...
const pulp_fiction_1 = require("@ponicode/pulp-fiction");
...
class PyRunner {
    static init(entryPath, pythonPath) {
        ...
        PyRunner.pyshell = new python_shell_1.PythonShell(entryPath, {
            pythonPath: pythonPath !== null && pythonPath !== void 0 ? pythonPath : "python3",
    ...
    async runTest(payload) {
        ...
        try {
            ...
            const testFile = utils_1.createTmpFile(this.payload.sourceFile.path, this.payload.testFile.code, PyRunner.onError);
            assert_1.default(testFile, `There were an error while creating the test file ${path.dirname(this.payload.sourceFile.path)}`);
            ...
            const defPromise = pulp_fiction_1.createDeferredPromise();
            ...
            utils_1.removeTmpFile(this.testFilePath, this.testFileName, PyRunner.onError);
            return report;
        }
        catch (e) {
            ...
            if (((_a = PyRunner.pyshell) === null || _a === void 0 ? void 0 : _a.terminated) != false) {
                msg =
                    "Runner Python is not loaded. Make sure you have installed the dependencies and use a Python version >= 3.6.0, and reload the window.";
            }
