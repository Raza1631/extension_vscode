...
from lib import py_native_to_input_value, NotSupported
...
def run_test(test, reach, verbose=True):
    ...
    pytest.main(pytest_options, plugins=[p, report_plugin])
